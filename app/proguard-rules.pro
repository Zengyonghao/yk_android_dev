...
#指定代码的压缩级别
    ...
    -dontwarn com.googlezxing.**
    -keep class com.googlezxing.** { *; }
    ...
    -keep class com.zplh.zplh_android_yk.bean.** { *; }
    ...
    -keep class com.android.volley.** { *; }
        ...
        -dontwarn com.wanj.x007_common.**
        -keep class com.wanj.x007_common.** { *; }
