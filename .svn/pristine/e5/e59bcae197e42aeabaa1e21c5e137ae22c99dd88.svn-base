...
public class JPushOperationPresenter extends BasePresenter<OperationView> {
    ...
    public JPushOperationPresenter(Context context, OperationView operationView) {
...
//                ShowToast.show("拉群后改名完成", (Activity) context);
            ...
            for (int a = 0; a < nodeList.size(); a++) {
                ...
                if (nodeBean.getResourceid() != null && nodeBean.getResourceid().equals("com.tencent.mm:id/i_") && nodeBean.getContentdesc() != null && nodeBean.getContentdesc() != "" && !nodeBean.getContentdesc().startsWith("微信") && nodeBean.getContentdesc().startsWith("ZZZ0")) {
...
//                ShowToast.show("任务被中断，结束修改备注任务", (Activity) context);
            ...
            for (int b = 0; b < nodeList.size(); b++) {
                ...
                if (nodeBean.getResourceid() != null && nodeBean.getResourceid().equals("com.tencent.mm:id/i_") && nodeBean.getContentdesc() != null && nodeBean.getContentdesc() != "" && !nodeBean.getContentdesc().startsWith("微信") ) {
