...
public class WxNumBean implements Serializable{
    ...
    public static class ContentBean implements Serializable{
         ...
         * friends_num : 16
         */
        private String account; //目前微信的帐号
        private String location; //目前微信的位置

        private  String  zzz9_friend_count; //ZZZ9的好友数

        public String getZzz9_friend_count() {
            return zzz9_friend_count;
        }

        public void setZzz9_friend_count(String zzz9_friend_count) {
            this.zzz9_friend_count = zzz9_friend_count;
        }
